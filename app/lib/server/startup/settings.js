...
settings.addGroup('Rate Limiter', function() {
	...
	this.section('API Rate Limiter', function() {
		this.add('API_Enable_Rate_Limiter', false, { type: 'boolean' });
		this.add('API_Enable_Rate_Limiter_Dev', false, { type: 'boolean', enableQuery: { _id: 'API_Enable_Rate_Limiter', value: true } });
		this.add('API_Enable_Rate_Limiter_Limit_Calls_Default', 1000000, { type: 'int', enableQuery: { _id: 'API_Enable_Rate_Limiter', value: false } });
		this.add('API_Enable_Rate_Limiter_Limit_Time_Default', 60000, { type: 'int', enableQuery: { _id: 'API_Enable_Rate_Limiter', value: false } });
	});
});
